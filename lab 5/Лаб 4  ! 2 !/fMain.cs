...
namespace Лаб_4____2__
{
    public partial class fMain : Form
    {
        ...
        private void fMain_Load(object sender, EventArgs e)
        {
            ...
            column = new DataGridViewTextBoxColumn();
            column.DataPropertyName = "operMemmory";
            ...
            bindSrcComp.Add(new Comp("Вася266", "Крокодил", "Казах Абрамович", 123, 123, 123, true, false));
        ...
        private void btnOpenFromText_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    sr = new StreamReader(openFileDialog.FileName, Encoding.UTF8); // Ініціалізувати sr тут
                    string s;

                    while ((s = sr.ReadLine()) != null)
                    {
                        string[] splits = s.Split('\t');
                        Comp comp = new Comp(splits[0], splits[1], splits[2],
